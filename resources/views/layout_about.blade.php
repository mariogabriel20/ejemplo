...
<head>
	<title>Dog Home Animals Category Bootstrap Responsive Website Template | About Us :: W3layouts</title>
	<!-- Meta tag Keywords -->
					...
					<div class="nav_w3ls">
						<nav>
							...
							<ul class="menu">
								<!-- ARREGLAR ACAAA -->
								<li><a href="/">Home</a></li>
								<li class="mx-lg-4 mx-md-3 my-md-0 my-2"><a href="/about" class="active">About Us</a></li>
...
<!-- testimonials -->
	...
	<div class="team py-5" id="team">
		<div class="container py-xl-5 py-lg-3">
			<h3 class="title-w3 text-bl text-center font-weight-bold mb-sm-5 mb-4">Dog Trainers
			</h3>
