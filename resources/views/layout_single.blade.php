...
<head>
	<title>Dog Home Animals Category Bootstrap Responsive Website Template | Single :: W3layouts</title>
	<!-- Meta tag Keywords -->
		...
		<div class="container py-xl-5 py-lg-3">
			...
			<div class="row blog-content pt-lg-3">
				...
				<div class="col-lg-8 blog_section">
					...
					<a href="/single" class="single-text text-bl font-weight-light my-3">Nemo enim ipsam voluptatem quia
						voluptas
					...
					<a href="/single" class="text-bl font-weight-bold blog-grid-title mt-4 mb-3">Two Column Text Sample</a>
					<div class="row">
						<div class="col-md-6">
					...
					<a href="/single" class="single-text text-bl font-weight-light mt-4">Nemo enim ipsam voluptatem quia
